...
if __name__ == '__main__':
    ...
    df.to_csv('C:\\Users\localadmin\PycharmProjects\Varjo_HeadMount\data\\varjodata\\vehicle1\Varjo_data_vehicle1_{}.csv'.format(datetime.now().strftime("%Y-%m-%d %H%M%S")), index=False)
