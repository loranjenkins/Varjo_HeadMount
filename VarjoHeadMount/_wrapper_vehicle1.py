...
if __name__ == '__main__':
    ...
    Varjo_live_dict = {'epoch_vehicle1': [], 'HMD_rotation_vehicle1': [], 'gaze_forward_vehicle1': []}
    ...
    df.to_csv(r'C:\Users\localadmin\PycharmProjects\Varjo_HeadMount\data\varjodata\vehicle1\Varjo_data_vehicle1_{}.csv'.format(datetime.now().strftime("%Y-%m-%d %H%M%S")), index=False)
